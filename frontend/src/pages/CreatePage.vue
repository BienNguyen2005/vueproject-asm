<template>
  <PageHeader title='Create New Article' subHeading='Share your story with the world' bg='assets/img/create-bg.jpg' />
  
  <div class="create-page">
    <div class="container">
      <div class="form-container">
        <form id="createForm" @submit.prevent="createArticle">
          <!-- Title Input -->
